...
const Search = () => {
  ...
  return (
    <div className='w-full  search  min-w-[300px] lg:min-w-[420px] h-11 lg:h-12 rounded-lg border overflow-hidden flex items-center text-neutral-500 bg-stone-300 group focus-within:border-primary-200 '>
        <div>
            {
